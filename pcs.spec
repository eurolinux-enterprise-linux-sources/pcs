...
Patch9999: 9999-eurolinux.patch
# git for patches
BuildRequires: git
...
* Fri Aug 30 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 
- Change branding for EL

* Thu Aug 08 2019 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Replaced Source: HAM-logo.png
-->  Remove TUV's branding logo and use SL
- Added Source: pcs.ini
