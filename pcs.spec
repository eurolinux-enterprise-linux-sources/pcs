...
Patch6: secure-cookie.patch
Patch7: bz1253287-fixed-session-and-cookies-processing.patch
Patch8: bz1253291-fixed-command-injection-vulnerability.patch
Patch9: bz1283239-fix-cluster-properties-page-in-web-UI.patch
...
%changelog
* Thu Nov 19 2015 Tomas Jelinek <tojeline@redhat.com> - 0.9.139-9.el6_7.2
- Fixed Cluster Properties page in web UI
- Resolves: rhbz#1283239

* Fri Aug 14 2015 Tomas Jelinek <tojeline@redhat.com> - 0.9.139-9.el6_7.1
- Fixed session and cookies processing
- Fixed command injection vulnerability
- Resolves: rhbz#1253287 rhbz#1253291
